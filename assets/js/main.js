jQuery(document).ready(function ($) {
    ...
    //    FAQ
    $('.my_faq .question').click(function () {
        $(this).parent().find('.collapse').toggle(500);
    });
    ...
    $('#c-show').click(function () {
        if ($('#currentPass').attr('type') == 'text') {
            ...
            $('#c-show').removeClass('fa fa-eye-slash').addClass('fa fa-eye');
        } else {
            $('#currentPass').attr("type", "text");
            $('#c-show').removeClass('fa fa-eye').addClass('fa fa-eye-slash');
        }
    });
