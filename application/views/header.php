...
<header>
    <div class="container">
        ...
        <div class="search-cate" >
            <input type="search" placeholder="Search entire store here..." onkeypress="search_enter(event);" id="transcript" >
                                        ...
                                        foreach ($sub as $subdata) {
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <ul>
                                                    ...
                                                    ?>
                                                        <li><a style="color: blue !important" href="<?php echo base_url(); ?>collections/sub-collection/<?php echo base64_encode(base64_encode($subdata->category_id)); ?>">View All <?php echo $subdata->name . " " . $maindata->name; ?></a></li>
                                                </ul>
                                            </div>
                                            <?php
                                        }
