                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">View All confirm Order</h4>
                        ...
                        <div class="row">
                            <div class="card col-12">
                                ...
                                <div class="card-header row col-12">
                                    <div class="col-6">
                                        <h4 class="card-title" style="padding-top: 10px">View All confirm Order</h4>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr align="center" valign="">
                                                    ...
                                                    <td style="width: 45%;text-align: left;vertical-align: top; ">
                                                        <?php
                                                            $tran_data = $this->md->my_query("SELECT t.* , p.`seller_id` FROM `tbl_bill` AS b , `tbl_transaction` AS t , `tbl_product` AS p WHERE b.`bill_id` = t.`bill_id` AND t.`product_id` = p.`product_id` AND b.`bill_id` = ".$bdata->bill_id." AND p.`seller_id` = ".$this->session->userdata('seller'));
