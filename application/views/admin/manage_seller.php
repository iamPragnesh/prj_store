                        ...
                        <div class="row">
                            ...
                            <div class="card col-12">
                                ...
                                <div class="card-header row col-12">
                                    <div class="col-6">
                                        <h4 class="card-title" style="padding-top: 10px">View All Seller</h4>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive w-100" style=" vertical-align: middle">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($seller as $data) {
                                                $c++;
                                                $city = $this->md->my_select('tbl_location','*',array('location_id'=>$data->location_id))[0]->name;
                                                ?>
                                                <tr align="center" valign="">
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <a style="cursor: pointer" target="_new" href="<?php echo base_url() . $data->profile_pic; ?>">
                                                                <img src="<?php echo base_url() . $data->profile_pic; ?>" alt="Workplace" usemap="#workmap" width="50px" height="50px" data-bs-toggle="tooltip"  data-bs-placement="bottom" title="<?php echo $data->company_name; ?>">
                                                            </a>
                                                        <?php
                                                        } 
                                                        else 
                                                        {
                                                        ?>
                                                            <a style="cursor: pointer" target="_new" href="<?php echo base_url(); ?>admin_assets/images/logo.jpg">
                                                    ...
                                                    <td>        
                                                        ...
                                                        if ($data->status == 1) {
                                                            ?>
                                                            <i class="fa fa-toggle-on"  onclick="change_status('seller',<?php echo $data->seller_id; ?>)" id="status_<?php echo $data->seller_id; ?>"  style="cursor:pointer;color:#5156be;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Active"></i>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <i class="fa fa-toggle-off"  onclick="change_status('seller',<?php echo $data->seller_id; ?>)" id="status_<?php echo $data->seller_id; ?>"  style="cursor:pointer" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Dective"></i>
