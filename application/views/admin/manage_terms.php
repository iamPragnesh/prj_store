                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Terms And Condition</h4>
                            ...
                            if (isset($editterms)) {
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="padding-top: 10px">Edit Terms And Condition</h4>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="" name="terms" novalidate="" class="myform">
                                            <div id="ckeditor-classic">
                                                <textarea required="" name="terms" id="editor1" rows="5" cols="70">
                                                    <?php
                                                    if (!isset($success) && set_value('terms')) {
                                                        echo set_value('terms');
                                                    } else {
                                                        echo $editterms[0]->data;
                                                    }
                                                    ?>
                                                </textarea>
                                            </div></br></br>
                                            ...
                                            &nbsp;
                                            <a type="reset" class="btn waves-effect waves-light" href="<?php echo base_url(); ?>manage-termsus">Go Back</a>
                                            <br/><br/>
                                            <div class="pt-2">
                                                <?php
                                                if (isset($success)) {
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="padding-top: 10px">Write Terms And Condition</h4>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="post" novalidate="" name="terms">
                                            <div id="ckeditor-classic">
                                                <textarea required="" name="terms" id="editor1" rows="5" cols="70">
                                                    <?php
                                                    if (!isset($success) && set_value('terms')) {
                                            ...
                                            <div class="pt-2">
                                                ...
                                                if (isset($success)) {
                                                    ?>                              
                                                    <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                                        <i class="mdi mdi-check-all label-icon"></i><strong>Ok</strong> - Terms And Condition Insert Successfully.
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                                    </div>
                                                    <?php
                                                }
                                                if (isset($error)) {
                                                    ?>
                                                    <div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                                        <i class="mdi mdi-block-helper label-icon"></i><strong>Oops!</strong> - Please Insert Terms And Condition.
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                                    </div>
                                                    <?php
                                                }
                                                if (isset($error1)) {
                                                    ?>
                                                    <div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                                        <i class="mdi mdi-block-helper label-icon"></i><strong>Oops!</strong> - Terms And Condition Already exists.
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                                    </div>
                                                    <?php
                                                }
                            ...
                            <div class=" card col-12">
                                <div class="">
                                    <div class="card-header row col-12">
                                        <div class="col-6">
                                            <h4 class="card-title" style="padding-top: 10px">View All Terms And Condition</h4>
                                        </div>
                                        <div class="col-6">
                                            <p class="card-title-desc" align="right" data-bs-toggle="modal" data-bs-target="#myModal" style="cursor: pointer" >
                                                <a onclick="delete_link('terms/<?php echo base64_encode(base64_encode(0)); ?>')"  class="btn btn-danger w-md">Delete All Records</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($terms as $data) {
                                                    ...
                                                    <tr align="center" valign="">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() ?>manage-terms/<?php echo base64_encode(base64_encode($data->terms_id)); ?>" style="cursor: pointer">
                                                                <i class="fas fa-pencil-alt" data-bs-toggle="tooltip" data-bs-placement="bottom"title="Edit"></i>
                                                            </a>  
                                                        </td>
                                                        <td>
                                                            <a onclick="delete_link('terms/<?php echo base64_encode(base64_encode($data->terms_id)); ?>');" data-bs-toggle="modal" data-bs-target="#myModal" style="cursor: pointer" >
