            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">   
                    <?php
                        ...
                        {                  
                    ?>   
                    <img class="rounded-circle header-profile-user" src="<?php echo base_url().$data->profile_pic; ?>" alt="Admin Panel">
                    <?php
                        }
                        else
                        {
                    ?>
                    <img class="rounded-circle header-profile-user" src="<?php echo base_url(); ?>admin_assets/images/user.jpg" alt="Admin Panel">       
                    <?php 
                        }
                    ?>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="<?php echo base_url(); ?>manage-setting"><i class="fas fa-cog"></i>&nbsp; Setting</a>
