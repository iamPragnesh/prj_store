...
//    die();
    ...
    foreach ($products as $data) 
    {
        ...
        <div class="row text-center mt-5">
            <div class="col-md-12">
                <br/>
                <button class="btn btn-round" onclick="product_data('<?php echo $action; ?>','<?php echo base64_encode(base64_encode($id)); ?>','<?php echo $limit; ?>');">View More Products</button>
            </div>
        </div>
        <?php 
        }
    ...
    {
        echo "<br/><br/><br/><br/><br/><div class='text-center'><h1 style='color:#ddd;'>No Product Found.</h1></div>";
    }
    ?>
</div>    
<?php
